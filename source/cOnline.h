...
public:
    ...
    template <typename T> coreInt32 SubmitScore      (const coreUintW iTableID, const coreString& sScore, const coreUintW iSort, const coreString& sExtraData, const coreString& sGuestName, GJ_NETWORK_OUTPUT(gjScorePtr));
