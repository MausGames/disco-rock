...
, m_TimeValueMil    (FONT_ROCKS, 67, 4)
, m_TimeValueSec    (FONT_ROCKS, 67, 8)
...
void cInterface::Move()
{
    ...
    {
        m_ComboBack.SetAlpha(fAlpha*0.75f);
        m_ComboBack.Move();
    }
    ...
    // display jump status
    m_Jump.SetColor3(g_pGame->GetRock()->GetJumped() ? COLOR_ORANGE_F.xyz() : COLOR_WHITE_F.xyz());
