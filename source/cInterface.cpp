...
: m_Score        (FONT_ROCKS, 40, 0)
, m_ScoreValue   (FONT_ROCKS, 50, 16)
, m_Time         (FONT_ROCKS, 40, 0)
, m_TimeValueSec (FONT_ROCKS, 50, 4)
, m_TimeValueMil (FONT_ROCKS, 50, 8)
, m_Combo        (FONT_ROCKS, 40, 8)
, m_ComboValue   (FONT_ROCKS, 50, 8)
...
, m_Hide         (coreTimer(1.0f, 1.0f, 1))
{
    ...
    m_ScoreValue.SetPosition(coreVector2(0.01f,-0.01f));
    m_ScoreValue.SetText("000000"); 

    m_Score.SetCenter(m_ScoreValue.GetCenter());
    m_Score.SetAlignment(m_ScoreValue.GetAlignment());
    m_Score.SetPosition(m_ScoreValue.GetPosition() + coreVector2(0.0f,-0.06f));
