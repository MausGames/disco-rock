...
void CoreApp::Setup()
{
    ...
    Core::Manager::Resource->Load<coreTexture>("button_login.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_login.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_logout.webp",       CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_logout.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_move.webp",         CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_move.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_ok.webp",           CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_ok.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_pause.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_pause.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_play.webp",         CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_play.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_score.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_score.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_scroll.webp",       CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_scroll.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_time.webp",         CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_time.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("button_trophy.webp",       CORE_RESOURCE_UPDATE_AUTO,   "data/textures/button_trophy.webp", CORE_TEXTURE_LOAD_R);
    ...
    Core::Manager::Resource->Load<coreTexture>("effect_particle.webp",     CORE_RESOURCE_UPDATE_AUTO,   "data/textures/effect_particle.webp", CORE_TEXTURE_LOAD_R);
    ...
    Core::Manager::Resource->Load<coreTexture>("icon_audio_1.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/icon_audio_1.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("icon_audio_2.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/icon_audio_2.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("icon_load.webp",           CORE_RESOURCE_UPDATE_AUTO,   "data/textures/icon_load.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("icon_success.webp",        CORE_RESOURCE_UPDATE_AUTO,   "data/textures/icon_success.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("icon_trophy.webp",         CORE_RESOURCE_UPDATE_AUTO,   "data/textures/icon_trophy.webp", CORE_TEXTURE_LOAD_R);
    Core::Manager::Resource->Load<coreTexture>("maus_logo.webp",           CORE_RESOURCE_UPDATE_AUTO,   "data/textures/maus_logo.webp");
    Core::Manager::Resource->Load<coreTexture>("rock.webp",                CORE_RESOURCE_UPDATE_AUTO,   "data/textures/rock.webp", CORE_TEXTURE_LOAD_NO_COMPRESS);
    ...
    Core::Manager::Resource->Load<coreShader> ("border.frag",              CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/border.frag", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    Core::Manager::Resource->Load<coreShader> ("color.frag",               CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/color.frag", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    Core::Manager::Resource->Load<coreShader> ("color_bar.frag",           CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/color_bar.frag", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    Core::Manager::Resource->Load<coreShader> ("color_icon.frag",          CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/color_icon.frag", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    ...
    Core::Manager::Resource->Load<coreShader> ("fill.vert",                CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/fill.vert", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    Core::Manager::Resource->Load<coreShader> ("fill.frag",                CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/fill.frag", CORE_SHADER_OPTION_NO_PERSPECTIVE);
    ...
    Core::Manager::Resource->Load<coreShader> ("simple_2d.vert",           CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/simple_2d.vert", CORE_SHADER_OPTION_NO_PERSPECTIVE);
